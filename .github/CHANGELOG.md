...
13. AIRAC (2513) - Updated Newquay (EGHQ) runway headings - thanks to @shivam123-dev (Shivam Singh)
14. AIRAC (2513) - Updated Jersey (EGJJ) runway headings - thanks to @shivam123-dev (Shivam Singh)
...
8. Enhancement - Added temporary Aldergrove (EGAA) Delivery frequency - thanks to @BenWalker01Aldergrove (EGAA) delivery
...
9. Bug - Improved display of EGPN/QL inbound standing agreement from Deancross to Talla - thanks to @hazzas-99
10. Enhancement - Added COPX display of 'COORD' for EGPN/QL inbounds sector sequence Talla-Galloway-Tay - thanks to @hazzas-99
11. Enhancement - Renamed standing agreement files to use full sector name - thanks to @aidenbok203 (Aiden Bok)
...
5. AIRAC (2402) - Replaced temporary danger area EGD597 with permanent EGD514 - thanks to @rishab-alt and @PLM1995 (Peter Mooney)
...
13. Procedure Change - Added Inverness Radar Delegated airspace - thanks to @GeekPro101 (Thomas Mills) and @hazzas-99
14. Procedure Change (2007) - Introduced AC West to Bristol agreements when Cardiff is offline - thanks to @hazzas-99
...
19. Enhancement - Improved depiction of NIMAT-ROTEV Buffer - thanks to @hazzas-99
...
10. Bug - Corrected London AC Clacton static boundary - thanks to @hazzas-99
...
9. Bug - Fixed auto-handoff for PC East (Stafa) -> AC Daventry (S27) MTMA outbounds when TC Midlands online - thanks to @hazzas-99
...
17. Bug - Amended Clacton (S14) -> TC East (SABER) agreements for EGKK inbounds - thanks to @hazzas-99
18. Bug - Improved COPX display for TC SW -> AC Worthing EGLL outbounds via MID - thanks to @hazzas-99
19. Bug - Fixed Worthing -> Dover COPX for Midlands Inbounds - thanks to @hazzas-99
...
2. Enhancement - Added Donegal (EIDL) basic info and airspace - thanks to @gdonohoe (Gregg Donohoe) and @hazzas-99
...
6. Bug - Fixed TC Welin -> NX APP VELAG COPX - thanks to @hazzas-99
7. Bug - Amended Bristol Region Naming Bug - thanks to @AleksMax (Aleks Nieszczerzewski)
8. Bug - Fixed EB-- inbound arrival agreements D->EBBU - thanks to @hazzas-99
9. Enhancement - Brussels (EBBU) 'fallback' ownership priority - thanks to @hazzas-99
...
27. Bug - Fixed TC Welin -> BB APP auto handoff prediction - thanks to @hazzas-99
28. Enhancement - Added agreements for arrivals between TC Cowly and BB APP for GROVE 1B arrivals - thanks to @hazzas-99
29. Bug - Fixed auto handoff next sector prediction for TC Welin -> S28 LTMA outbounds - thanks to @hazzas-99
30. Enhancement - Removed Filton (EGTG - closed) agreements and added St Athan (EGSY) agreements - thanks to @hazzas-99
...
39. Enhancement - Renamed references to MAN -> PC - thanks to @hazzas-99
...
11. Bug - Corrected Scottish AC Humber -> EHAA low agreements for EHAM inbounds - thanks to @hazzas-99
12. AIRAC (1902) - Edited Manchester/Barton frequency - thanks to @itsbenny99 (Benjamin Matthews)
13. Bug - Corrected Manchester (EGCC) top-down ownership - thanks to @hazzas-99
14. Bug - Fixed STC_W position identifier - thanks to @daleb99 (Dale Brooksby)
15. Enhancement - Optimised AC South -> AC Dover agreements for BB/GD/FF departing traffic - thanks to @hazzas-99
16. Enhancement - Added airspace and positions for Scilly Isles (EGHE) - thanks to @dswoodward (Dave Woodward) and @hazzas-99
...
29. Enhancement - Optimised COPX point for S29->S27 EGNM/NO/NH outbound agreements - thanks to @hazzas-99 and @aturneruk (Adam Turner)
...
32. Bug - Fixed SS FIN -> TC NW outbound agreements - thanks to @hazzas-99
33. Enhancement - Added agreements between PC East sectors - thanks to @hazzas-99
...
38. Enhancement - Improved functionality of EGKK LAM departure agreements - thanks to @hazzas-99
39. Enhancement - Removed Solent online ring display to AC Dover - thanks to @hazzas-99
40. Enhancement - Belfast TMA standing agreements - thanks to @kye-taylor (Kye Taylor) and @hazzas-99
41. Enhancement - Updated TC NW sector definition to reflect 155/165 split - thanks to @hazzas-99
42. Bug - Fixed various line display issues in the LTC area - thanks to @hazzas-99
43. Bug - Fixed Deancross to ScTMA (Talla) inbound ScTMA agreements - thanks to @hazzas-99
44. Enhancement - Added agreements between PC West sectors - thanks to @hazzas-99
...
54. Bug/Enhancement - Optimised agreements for LTMA departures in TC/AC Clacton region - thanks to @hazzas-99 & @aturneruk (Adam Turner)
...
3. Bug - Updated UK Fixes to match AIRAC 2001 - thanks to @hazzas-99
...
8. Enhancement - Post-AFV frequency changes (Birmingham Approach now 123.970; Battersea Tower now 134.270; Shannon Information now 127.500) - thanks to @hazzas-99
9. Bug - Fixed Observing ownership for Essex, EGTC, EGTK and EGWU airfields following 2001 Daventry changes - thanks to @hazzas-99
10. Bug - Fixed Observing ownership for AC Daventry sectors following changes in 2001 - thanks to @hazzas-99
11. Bug - Corrected line display and ownership for Birmingham (EGBB) and East Midlands (EGNX) - thanks to @hazzas-99
12. Enhancement - Updated alternate ownership for adjacent airports (000A) to reflect Daventry changes - thanks to @hazzas-99
13. Bug - Fixed Observing ownership for TC NW sector following changes in 2001 - thanks to @hazzas-99
14. AIRAC (2002) - EGKK SMR Update (stand 49R amended, stand 157 removed) - thanks to @Keanu73 (Keanu Czirjak)
15. Enhancement - Adds extra COPX for S5->S29 EGNT/NV/NJ arrival agreements - thanks to @hazzas-99
16. Enhancement - Added TC NE split functionality (LOREL and LAM sectors) - thanks to @hazzas-99
17. Enhancement - Added Honiley Radar Gate (turn on under Stars) - thanks to @hazzas-99
...
9. Bug - Fixed Gatwick (EGKK) ABSAV STAR routing, adding HOLLY - thanks to @hazzas-99
10. AIRAC (1912) - Y91/UY91 redesignated L149 - thanks to @LEWISC44 (Lewis Corcoran)
11. AIRAC (2001) - Amended EG D005B danger area - thanks to @hazzas-99
12. Enhancement - Added Dublin (EIDW) runway definitions - thanks to @hazzas-99
13. Enhancement - Updated EIDW sectors and Irish Sea delegated airspace - thanks to @hazzas-99
...
28. Bug - Added missing Newcastle (EGNT) and Durham (EGNV) inbound agreements, S28->East - thanks to @hazzas-99
29. Bug - Added missing Manchester (EGCC) and Liverpool (EGGP) inbound agreements, S28->Trent - thanks to @hazzas-99
...
32. Bug - Fixed EGLL/EGWU inbound agreement via FITBO - thanks to @hazzas-99
33. Bug - Updated Northolt (EGWU) STARs - thanks to @hazzas-99
...
9. AIRAC (1910), Enhancement - Updated Gatwick (EGKK) Non-RNAV SID fixes - thanks to @hazzas-99
...
24. Bug - Removed duplicate position identifier for AC Bandbox frequency preventing controller handover ownership issues - thanks to @hazzas-99
...
2. Enhancement - Updated various London (AC/TC) frequencies - thanks to @hazzas-99
...
9. Enhancement - Backend changes to IBNOS area sector line names - thanks to @hazzas-99
...
12. AIRAC (1910) - Extended Irish CTA 1 and Strangford CTA - thanks to @hazzas-99
13. Enhancement - Added climbing/descending arrows to agreements from ScAC East sectors - thanks to @hazzas-99
...
3. Enhancement - Added climbing/descending arrows to agreements from TC South sectors - thanks to @hazzas-99
4. Enhancement - New Aberdeen (EGPD) SMR - thanks to @hazzas-99
...
8. Enhancement - Added Sumburgh (EGPB) online rings - thanks to @hazzas-99
9. Enhancement - Added ability to Observe SCO_CTR w/out STC, for when mentoring is split between SCO/STC thanks to @hazzas-99
10. Enhancement - Added various bandbox/split possibilities for ScAC and STC - thanks to @hazzas-99
...
21. Enhancement - Removed obsolete AIRWAYS ARTCC High lines - thanks to @hazzas-99
22. Enhancement - Added climbing/descending arrows to agreements from ScTMA sectors - thanks to @hazzas-99
23. Enhancement - Added climbing/descending arrows to agreements from STC Antrim sector - thanks to @hazzas-99
24. AIRAC (1906) - Amended, truncated and remove various RNAV airways - thanks to @aturneruk (Adam Turner)
25. AIRAC (1910) - Updated various Gatwick (EGKK) SIDs - thanks to @hazzas-99

# Changes from release 2019/08 to 2019/09
1. AIRAC (1909) - Updated Cambridge (EGSC) squawk code range - thanks to @toms03 (Tom Earl)
2. Enhancement - Adjusted sector line between S10/S11 and Humber - thanks to @hazzas-99 and @aturneruk (Adam Turner)
3. Enhancement - Heathrow (EGLL) INT N frequency discrepancy note added - thanks to @hazzas-99
4. Enhancement - Adjusted static boundaries for S10/S11 and Humber - thanks to @hazzas-99
...
10. AIRAC (1906) - Updated Gatwick (EGKK) STARs via WILLO - thanks to @hazzas-99
11. AIRAC (1909) - Converted Y47 and Y124 airways to RNAV - thanks to @indianbhaji (Eric Liu)
12. Enhancement - Added missing Heathrow (EGLL) Taxiway S intermediate holding points - thanks to @hazzas-99
13. AIRAC (1907) - Biggin Hill (EGKB) Holding Point "AB" Removed - thanks to @nathaninnes (Nathan Innes)
14. Bug - Added new agreement rule for Stansted (EGSS) traffic via M183, FL160 TC NW -> AC S - thanks to @hazzas-99
...
2. Bug - Fixed Observing LTC_E_CTR altownership (for main sector and alternate airports) - thanks to @hazzas-99
3. AIRAC (1906) - Redesignated St Athan EGDX to EGSY - thanks to @hazzas-99
4. AIRAC (1907) - Redesignated Danger Area EG D701Z->D704 and updated naming for D809C/N/S - thanks to @hazzas-99
...
16. Enhancement - Added climbing/descending arrows to agreements from TC East and AC Central sectors - thanks to @hazzas-99
17. Enhancement - Added climbing/descending arrows to agreements from TC North sectors - thanks to @hazzas-99
...
26. Enhancement - Updated frequencies to (real-world) 136.XXX versions (KK, LC, MC ATISes; SS FIN) - thanks to @hazzas-99
27. Enhancement - Heathrow (EGLL) N1 reopened via NOTAM, added back to SMR - thanks to @hazzas-99
28. Enhancement - Updated MAN W and MAN E static boundaries - thanks to @hazzas-99
29. Enhancement - Added climbing/descending arrows to agreements from AC South Sectors - thanks to @hazzas-99
...
12. AIRAC (1905) - Heathrow (EGLL) stands 517 and 581 removed (archived in red) - thanks to @hazzas-99
13. AIRAC (1813) - Updated Inverness (EGPE) runway (11/29) track - thanks to @hazzas-99
...
19. AIRAC (1905) - Updated Hawarden (EGNR) VRPs - thanks to @hazzas-99
20. Enhancement - Updated DW arrival agreement, now 260 NELBO Rathlin->Antrim - thanks to @gdonohoe (Gregg Donohoe)
21. AIRAC (1905) - Updated Danger Area EG D403 - thanks to @hazzas-99
22. AIRAC (1905) - Updated Danger Area EG D512 - thanks to @hazzas-99
23. AIRAC (1905) - Updated Danger Area EG D513 - thanks to @hazzas-99
24. AIRAC (1905) - Luton (EGGW) hold F1 redesginated J1 - thanks to @hazzas-99
25. Bug - Corrected line display issues for JJCTR and London S6/LAC Worthing/LFRR - thanks to @hazzas-99
26. Enhancement - Added climbing/descending arrows to agreements from AC West sectors - thanks to @hazzas-99
27. Bug - Moved SSFIN sectorline to appropriate file - thanks to @hazzas-99
28. Bug - Corrected SSAPP line display conditions to show when using ALTOWNERSHIP - thanks to @hazzas-99
29. Bug - Updated sectors and ownership for ENSV_N/ENSV split - thanks to @hazzas-99
30. Enhancement - Updated Reykjavik sectorisation (BIRD_X) - thanks to @hazzas-99
31. Enhancement - Adjustments to Gatwick (EGKK) SMR (stands, Z1, grass) - thanks to @hazzas-99
32. AIRAC (1905) - Updated Danger Area EG D406 - thanks to @hazzas-99
33. AIRAC (1905) - Updated Heathrow (EGLL) runway track and threshold coordinates - thanks to @hazzas-99
...
7. Enhancement - Added Gander Oceanic frequency and ownership - thanks to @hazzas-99
8. Bug - Added agreements via INKOB/SOSIM for EGAA/AC outbounds Rathlin->AC North - thanks to @hazzas-99
...
13. AIRAC (1904) - Various airways redesignated as RNAV - thanks to @hazzas-99
14. Enhancement - Newquay SMR updated to include extra details - thanks to @danielbutton (Daniel Button)
15. AIRAC (1903) - Added EGPK RNAV approach fixes - thanks to @hazzas-99
...
14. Enhancement - TCE->E agreements enhanced with arrows and segregation for LEDBO/C2/C1 - thanks to @hazzas-99
...
29. AIRAC (1813) - Jersey (EGJJ) ORIST SIDs added - thanks to @hazzas-99
30. Bug - Added missing agreement for MAW->DUBN Dublin (EIDW) inbounds via SITKU - thanks to @hazzas-99
31. AIRAC (1813) - Gatwick (EGKK) CLN RNAV SIDs truncated and redesignated - thanks to @hazzas-99
32. AIRAC (1813) - Heathrow (EGLL) and Northolt (EGWU) LAM3A STAR redesignated - thanks to @hazzas-99
33. Bug - Added missing fix in Gatwick (EGKK) IMVUR1Z SID routing - thanks to @hazzas-99
34. AIRAC (1813) - Guernsey (EGJB) ORIST and LERAK SIDs added - thanks to @hazzas-99
35. AIRAC (1813) - EGSS/GW/SC STARs redesignated and files cleaned up - thanks to @hazzas-99
36. AIRAC (1813) - EGMC 8.33kHz frequencies added to doc file - thanks to @hazzas-99
37. AIRAC (1813) - Southend (EGMC) STAR redesignation - thanks to @hazzas-99
38. AIRAC (1813) - EGCC/GP/NR/NM/CN arrivals via LAKEY agreement changed - thanks to @hazzas-99
...
41. Bug - Fixed EKDK unclosed sector border lines - thanks to @hazzas-99
42. AIRAC (1813) - Heathrow SMR updated (WIP removed) - thanks to @cpawley (Chris Pawley)
43. AIRAC (1813) - Southampton (EGHI) and Bournemouth (EGHH) SAM1B->UMBUR1S STAR - thanks to @hazzas-99
44. AIRAC (1813) - Belfast/Aldergrove (EGAA) runway tracks updated - thanks to @hazzas-99
45. AIRAC (1813) - London/City (EGLC) and Biggin Hill (EGKB) SUMUM/XAMAN STARs redesignated - thanks to @hazzas-99
46. AIRAC (1813) - Gatwick (EGKK) TIMBA STARs redesignated / removed - thanks to @hazzas-99
47. AIRAC (1810) - Added Sumburgh (EGPB) RNAV approach fixes - thanks to @hazzas-99
48. AIRAC (1813) - Duxford (EGSU) basic and runway info updated - thanks to @hazzas-99
49. Bug - Update Bristol (EGGD) SMR - @Scotflieger (Andrew Gransden)
50. Bug - Corrected Stansted (EGSS) SID fixes - thanks to @hazzas-99
51. AIRAC (1813) - Inverness (EGPE) 8.33kHz spaced frequencies added to doc - thanks to @hazzas-99
52. Enhancement - Manchester (EGCC) SMR background colour set back to original - thanks to @hazzas-99
53. Bug - Fixed 'Virtual_Fixes' file extension - thanks to @hazzas-99
54. Enhancement - Added SASKI delegated airspace in ARTCC High - thanks to @hazzas-99
55. Enhancement - Removed redundant Coventry (EGBE) airspace and SMAA data - thanks to @hazzas-99
56. Enhancement - Guest ownership for TCNW (for KK WILLO3B) refined - thanks to @hazzas-99
57. Bug - Corrected S23->TCNW agreement for SS/GW/SC arrivals - thanks to @hazzas-99
58. Bug/Enhancement - Added missing EGNM inbound agreements from MAE->NMAPP - thanks to @hazzas-99
59. Bug - Corrected TOSVA fix coordinates - thanks to @hazzas-99
60. Bug - Fixed (and amended) Midlands (BB/NX) MAW->MAE inbound agreements - thanks to @hazzas-99
61. AIRAC (1813) - New agreement for Jersey Zone outbounds via ORIST - thanks to @hazzas-99
62. Bug - Added missing KK/Essex RRhigh_S inbound agreements via LUGIS and ODREP - thanks to @hazzas-99
63. Enhancement - Added Freetext for Links at Heathrow - thanks to @daleb99 (Dale Brooksby)
64. AIRAC (1813) - Various new agreements for Dutch interface in IBNOS area - thanks to @hazzas-99
65. AIRAC (1813) - EHAA FIR fixes updated (including new IBNOS area fixes) - thanks to @hazzas-99
66. AIRAC (1813) - IBNOS Delegated Area (EHAA->LAC/LTC), ARTCC, lines and ownership - thanks to @hazzas-99
...
1. AIRAC (1811) - CT (Coventry) NDB withdrawn - thanks to @hazzas-99
...
4. AIRAC (1811) - P2/UP2 now RNAV airways - thanks to @hazzas-99
5. AIRAC (1811) - Newquay (NQY) NDB relocated... ish! - thanks to @hazzas-99
6. AIRAC (1808) - Doncaster (EGCN) hold A3 repositioned, and other minor SMR updates - thanks to @hazzas-99
7. Bug - Updated EGBB squawk code range change (1810) for mentor positions - thanks to @hazzas-99
8. AIRAC (1811) - Carlisle (EGNC) APP position withdrawn - thanks to @hazzas-99
9. AIRAC (1811) - Carlisle (EGNC) ARP updated - thanks to @hazzas-99
10. AIRAC (1807) - Dundee EGPN runway track updated - thanks to @hazzas-99
11. AIRAC (1811) - Gloucestershire (EGBJ) runway track updated - thanks to @hazzas-99
12. AIRAC (1811) - Sumburgh (EGPB) frequency corrected in doc file - thanks to @hazzas-99
13. AIRAC (1811) - Stornoway (EGPO) runway track updated - thanks to @hazzas-99
14. AIRAC (1811) - Stornoway (EGPO) frequencies updated - thanks to @hazzas-99
15. Enhancement - Farnborough LARS (EGLF_R_APP) position defined - thanks to @hazzas-99
16. AIRAC (1811) - 8.33KHz freqs added to doc file for EGGD, LL, PA and PN - thanks to @hazzas-99
17. AIRAC (1811) - Carlisle (EGNC) runway designator/track change - thanks to @hazzas-99
18. AIRAC (1808) - EGCC SMR updates - thanks to @tasosb (Anastasios Mpithas)
19. AIRAC (1804) - Number of airways converted to RNAV - thanks to @hazzas-99
20. Enhancement - Updated some Glasgow (EGPF) stand and hold labels - thanks to @hazzas-99
21. Enhancement - Updated L18 S5->Dublin sector coordinates according to Holyhead CTA - thanks to @hazzas-99
22. Bug/Enhancement - Redefined EGNT APP airspace, and line display to MAN/SCO - thanks to @hazzas-99
23. AIRAC (1811) - Oxford (EGTK) frequencies updated - thanks to @hazzas-99
24. AIRAC (1808) - Heathrow (EGLL) BIG low level STARs withdrawn - thanks to @hazzas-99 & @daleb99 (Dale Brooksby)
...
28. Enhancement - Updated ALL 'General RNAV' fixes relating to SIDs/STARs, and associated agreements - thanks to @hazzas-99
...
1. Enhancement - LTC_CTR temporary note/comment removed - thanks to @hazzas-99
...
4. Enhancement - Removed old EGGP SIDs - thanks to @hazzas-99
5. Enhancement - Reordered EGSS SIDs to reflect permanent CLN1E and DET1D RNAVs - thanks to @hazzas-99
6. Enhancement - Removed old EGGW SIDs - thanks to @hazzas-99
...
13. Enhancement - Removed old EGLL DVR SIDs - thanks to @hazzas-99
14. Enhancement - Removed old EGSS DVR SIDs - thanks to @hazzas-99
15. Enhancement - Removed duplicate Manchester TMA drawing in SIDs (as well as ARTCC High) - thanks to @hazzas-99
16. AIRAC (1803) - EGHI frequencies updated in doc file (8.33 spacing) - thanks to @hazzas-99
17. Enhancement - Removed old EGPH SIDs - thanks to @hazzas-99
18. Enhancement - Removed old EGWU SIDs - thanks to @hazzas-99
...
22. Enhancement - Removed old EGCC SIDs - thanks to @hazzas-99
23. AIRAC (1806) - Upper Airways converted to RNAV and corresponding new fixes added - thanks to @daleb99 (Dale Brooksby)
24. Enhancement - Removed old EGNX SIDs - thanks to @hazzas-99
...
26. Enhancement - Removed old EGNM SIDs - thanks to @hazzas-99
27. Bug - Fixed Daventry->TCNW EGHI/HH inbounds via BAMBO (150) agreement display - thanks to @hazzas-99
...
34. Enhancement - Removed old EGKK ADMAG1X SID, replaced by ADMAG2X in 1606 - thanks to @hazzas-99
35. AIRAC (1806) - Archived KENET SIDs from 26L/26R, and KENET RNAV SIDs (replaced by IMVUR/NOVMA) - thanks to @hazzas-99
...
38. Enhancement - Amended line display for LTC N and LTC SE - thanks to @hazzas-99
...
7. AIRAC (1801) - Danger area EG R157 updated - thanks to @hazzas-99
...
27. Bug - Corrected airport line display references to 'London AC West' - thanks to @hazzas-99
28. DEVELOPERS ONLY - Added new 'Doc' to keep track of runway track changes that need further attention - thanks to @hazzas-99
...
33. AIRAC (1712) - Holyhead, Strangford and Irish Sea CTAs added (ARTCC High, 'OCAS' Black Regions, Airspace Bases) - thanks to @hazzas-99 and @daleb99 (Dale Brooksby)
...
37. Enhancement - Added Jersey Zone split position and improved line display to LON - thanks to @hazzas-99
38. Enhancement - Added Jersey (JJ), Guernsey (JB) and Alderney (JA) online rings - thanks to @hazzas-99
39. AIRAC (1713) - Removed N864 controlled airspace (FL155-195) portion between DCS and WAL - thanks to @hazzas-99
40. Bug - Added missing coordinate to West CTA (ARTCC High) - thanks to @hazzas-99
41. Enhancement/Bug - Added Solent APP positions online ring visibility for TC NW and London S6, and corrected display conditions - thanks to @hazzas-99
...
2. Bug - Added missing ownership for North Sea CTA 2 delegated airspace (EHAA) - thanks to @hazzas-99
3. Enhancement - Edinburgh (EGPH) Extended centrelines extended - thanks to @luke11brown (Luke Brown)
4. AIRAC (1711) - Updated Hawarden (EGNR) squawk code allocation range - thanks to @hazzas-99
5. Bug - Updated Glasgow (EGPF) squawk code allocation range - thanks to @hazzas-99
6. Enhancement - ScAC East static sector boundary defined - thanks to @hazzas-99
7. AIRAC (1710) - Updated West CTA coordinates and formatting - thanks to @hazzas-99
...
28. Enhancement - updated VATSIM frequencies doc with entry for Southend Tower - thanks to @hazzas-99
...
1. Corrected Copenhagen Control frequency (now 121.37) - thanks to @hazzas-99
...
10. AIRAC (1613) - Various removals, additions and updates to name-code designators (fixes) - thanks to @lpeters (Luke Peters) and @hazzas-99
11. AIRAC (1613) - Doncaster (EGCN) FNY1D STAR redesignated FNY2D, beginning at EMBOR - thanks to @lpeters (Luke Peters) and @hazzas-99
...
14. AIRAC (1701) - removal of 5 danger areas - thanks to @hazzas-99
15. AIRAC (1611) - East Midlands (EGNX) runway track updated - thanks to @hazzas-99
16. AIRAC (1610) - Various airway redesignations and updates, incl. Shoreham (EGKA) runway redesignation - thanks to @hazzas-99
17. Amended N864 airspace base between BHD and 5NM before EXMOR to FL65 - thanks to @hazzas-99
...
20. AIRAC (1607) - Heathrow (EGLL) SATUN hold respositioned and Link 25 removed - thanks to @hazzas-99
21. AIRAC (1701) - Heathrow (EGLL) SMR updated, removing/adding various construction areas - thanks to @hazzas-99
22. AIRAC (1611) - East Midlands (EGNX) Holds M4 and M5 Added - thanks to @arcticash (Ash Kirby)
23. AIRAC (1609) - Southend (EGMC) stands 12-16 replaced by stands 11-14 - thanks to @hazzas-99
24. Fixed Carlisle (EGNC) online ring display to MAN positions - thanks to @hazzas-99
25. Added London City (EGLC) / London CTR helicopter reporting point freetext - thanks to @hazzas-99
26. Corrected Southern CTA coordinates on northern boundary - thanks to @hazzas-99
...
34. AIRAC (1511) - Gatwick (EGKK) Pier 1 reinstated and holds A2 & A3 repositioned - thanks to @hazzas-99
35. AIRAC (1701) - Leeds (EGNM) stands updated - thanks to @hazzas-99
36. AIRAC (1701) - Doncaster (EGCN) stand updates and reconfiguration of taxiway E - thanks to @hazzas-99
37. AIRAC (1609) - Cambridge (EGSC) runway tracks and holds updated - thanks to @hazzas-99
...
6. AIRAC (1610) - Amended agreements between SS FIN and TC NW for truncated Stansted (EGSS) SIDs - thanks to @hazzas-99
...
13. AIRAC (1610) - Added new Strumble CTA to ARTCC High - thanks to @hazzas-99
14. AIRAC (1612) - Runway track updates at Cardiff (EGFF), Edinburgh (EGPH) and Aberdeen (EGPD) - thanks to @hazzas-99
15. AIRAC (1611) - Cardiff (EGFF) RNAV approaches and associated airfield fixes - thanks to @hazzas-99

# Changes from release 2016/07 to 2016/09
1. Fixed AC North static boundary, adding previously missed lines - thanks to @hazzas-99
2. Added AC West sector static boundary - thanks to @hazzas-99
3. Added Ronaldsway (EGNS) VRPs - thanks to @agent_squash (Alex Ashley)
4. Amended agreement between Heathrow INT S and TC SW and added CPT radar gate - thanks to @hazzas-99
5. AIRAC (1608) - Liverpool (EGGP) RNAV approach fixes added - thanks to @agent_squash (Alex Ashley)
6. Added squawk ranges to various London ACC event only splits - thanks to @hazzas-99
7. Added La Manche delegated airspace as ARTCC High data - thanks to @hazzas-99
8. AIRAC (1607) - Belfast (EGAA) runway coordinates and 07/25 extended centreline updated - thanks to @hazzas-99
9. AIRAC (1608) - Kirkwall (EGPA) RNAV approach fixes added - thanks to @hazzas-99
10. AIRAC (1609) - Barra (EGPR), Islay (EGPI) and Land's End (EGHC) RNAV approach fixes added - thanks to @hazzas-99
11. AIRAC (1609) - Birmingham (EGBB) Runway 15 2Y RNAV SIDs now permanent procedure - thanks to @hazzas-99
12. AIRAC (1609) - Southampton (EGHI) radar frequency updated to 122.720 - thanks to @hazzas-99
13. Sector Line, Ownership and Agreement changes relating to TC East and TC South airspace changes - thanks to @hazzas-99
14. Added EGPK, EGAE, EGPE and EGNC GND/TWR/APP sector rings to display to Area - thanks to @hazzas-99
15. AIRAC (1609) - Shoreham (EGKA) runway track and coordinate updates - thanks to @hazzas-99
16. AIRAC (1609) - N552 and N562 now RNAV routes, and N552 route updated - thanks to @hazzas-99

# Changes from airac-16-06 to airac-16-07
1. Adjusted default visibility centre and 'scaling' - thanks to @jpfox (Jamie Fox)
2. Added missing Scottish TMA 5 Class D airspace base label - thanks to @hazzas-99
3. Fixed ordering of Birmingham (EGBB) RWY 33 DTY SIDs - thanks to @hazzas-99
4. Fixed longitudinal indicator in Gatwick (EGKK) KKE10 coordinate - thanks to @hazzas-99
5. Added EGNX GND/TWR sector rings to display to Area - thanks to @hazzas-99
6. Added EGBB GND/TWR sector rings to display to Area - thanks to @hazzas-99
7. Added KEGUN arrivals to EGNR Stars.txt file - thanks to @hazzas-99
8. Added missing Newcastle (EGNT) ground position - thanks to @hazzas-99
9. Added EGNT GND/TWR sector rings to display to Area - thanks to @hazzas-99
...
12. AIRAC (1607) - Benbecula (BEN) VOR/DME now DME only - thanks to @hazzas-99
13. AIRAC (1607) - Barrow/Walney Island (EGNL) RNAV approaches and associated airfield fixes - thanks to @agent_squash (Alex Ashley)
14. AIRAC (1607) - Campbeltown (EGEC) and Wick (EGPC) RNAV approaches and associated airfield fixes - thanks to @hazzas-99
15. AIRAC (1607) - Carlisle (EGNC) runway track and coordinate updates - thanks to @hazzas-99
16. AIRAC (1513) - Removed Belfast (EGAA) ground position - thanks to @hazzas-99
17. Added EGAA TWR/APP sector rings to display to Area - thanks to @hazzas-99
18. Added new Newquay (EGHQ) ground map - thanks to @agent_squash (Alex Ashley)

# Changes from airac-16-03 to airac-16-06
1. Fixed Antrim callsign suffix, fixing ownership/position identification - thanks to @hazzas-99
2. Fixed erroneous longitudinal prefix in KKS17 (BOGNA/HARDY EGKK SIDs) - thanks to @hazzas-99
3. Updated LTC sector line display, particularly for LTC_SW - thanks to @hazzas-99
...
3. Removed geo lines from JACKO/GURLU to the start of the EGLC point merge arc - thanks to @hazzas-99
4. Added correct sector ownership for ENSV and EKDK thus also fixing some line display - thanks to @hazzas-99
5. Removed remaining references to Manston (EGMH) in agreements and in adjacent airport setup - thanks to @hazzas-99
...
8. Added EGCC GND/TWR/APP sector rings to display to Area - thanks to @hazzas-99
9. Added adjacent airports ownership for Scottish positions (000A Show adjacent departure airports) - thanks to @hazzas-99
10. Corrected Stornoway (EGPO) top-down priority - thanks to @hazzas-99
11. Added FL245 shelf/portion of the EGPX/EISN FIR - thanks to @hazzas-99
12. Fixed Lossiemouth/Kinloss MATZ airspace to fit ARTCC low naming conventions - thanks to @hazzas-99
...
18. Added AC Daventry sector static boundary - thanks to @hazzas-99
19. Added LTC NE and NW sector static boundaries - thanks to @hazzas-99
20. Reformatted RMA whitespace - thanks to @samw (Sam White) and @hazzas-99
21. Added missing Y3 airspace base (to the east of the EGGD CTA) - thanks to @hazzas-99
...
24. Added missing agreements to/from PEAPP - thanks to @hazzas-99
...
27. Adjusted CC INT/FIN sectors and inbound agreements with MAN - thanks to @hazzas-99
28. Added AC Dover sector static boundary - thanks to @hazzas-99
29. Added AC Clacton sector static boundary - thanks to @hazzas-99
30. Added AC Worthing sector static boundary - thanks to @hazzas-99
31. Updated French CTRs, added the Lille CTR, and updated the Deauville and Lille TMAs - thanks to @pierr3 (Pierre Ferran)
32. AIRAC - CAE NDB withdrawn; fix FERAS withdrawn; EG D323A danger area updated - thanks to @hazzas-99
